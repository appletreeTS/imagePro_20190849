...
// ImagePro___20190849Doc.cpp: CImagePro20190849Doc 클래스의 구현
//
...
// CImagePro20190849Doc

IMPLEMENT_DYNCREATE(CImagePro20190849Doc, CDocument)

BEGIN_MESSAGE_MAP(CImagePro20190849Doc, CDocument)
END_MESSAGE_MAP()


// CImagePro20190849Doc 생성/소멸

CImagePro20190849Doc::CImagePro20190849Doc() noexcept
{
	inputImg = NULL;
	inputImg2 = NULL;
	resultImg = NULL;
...
CImagePro20190849Doc::~CImagePro20190849Doc()
{
	int i;
	if (inputImg != NULL)
	{
...
BOOL CImagePro20190849Doc::OnNewDocument()
{
...
// CImagePro20190849Doc serialization

void CImagePro20190849Doc::Serialize(CArchive& ar)
{
	if (ar.IsStoring())
	{
...
// 축소판 그림을 지원합니다.
void CImagePro20190849Doc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
...
// 검색 처리기를 지원합니다.
void CImagePro20190849Doc::InitializeSearchContent()
{
...
void CImagePro20190849Doc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
...
// CImagePro20190849Doc 진단

#ifdef _DEBUG
void CImagePro20190849Doc::AssertValid() const
{
	CDocument::AssertValid();
}

void CImagePro20190849Doc::Dump(CDumpContext& dc) const
{
	CDocument::Dump(dc);
}
#endif //_DEBUG
...
// CImagePro20190849Doc 명령


int CImagePro20190849Doc::LoadImageFile(CArchive& ar)
{
	int maxValue, i;
	...
	else if (strcmp(strchr(fname, '.'), ".jpg") == 0 || strcmp(strchr(fname, '.'), ".JPG") == 0 ||
		strcmp(strchr(fname, '.'), ".jpeg") == 0 || strcmp(strchr(fname, '.'), ".JPEG") == 0)
	{
		ar.ReadString(type, 15);
		do {
			ar.ReadString(buf, 255);
...
int CImagePro20190849Doc::LoadSecondImageFile(CArchive& ar)
{
	int w, h, d;
	int maxValue, i;
	char type[16], buf[256];
